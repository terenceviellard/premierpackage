...
The goal of testpackage is to make regular expressions more exciting! It
...
devtools::install_github("terenceviellard/testpackage")
```
...
That’s exactly what `testpackage::str_split_one()` does.
